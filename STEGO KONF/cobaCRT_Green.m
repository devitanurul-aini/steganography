...
[M N O]=size(warna);
% stego=warna;
stego=warna(:); %matrik citra dijadikan 1 baris
...
hasil_gmb_stego=cat(3,red,gmb_stego,blue); %menggabungkan citra red, citra stego green dan blue
imwrite(hasil_gmb_stego,'stegoCRT_Green.bmp');
