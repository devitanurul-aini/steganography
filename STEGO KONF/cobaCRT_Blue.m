...
[M N O]=size(warna);
% stego=warna;
stego=warna(:); %matriks citra dijadikan 1 baris
...
hasil_gmb_stego=cat(3,red,green,gmb_stego); %menggabungkan citra red, green dan citra stego blue
imwrite(hasil_gmb_stego,'stegoCRT_Blue.bmp');
